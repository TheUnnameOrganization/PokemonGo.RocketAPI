...
namespace PokemonGo.RocketAPI.Helpers
{
    public class RequestBuilder
    {
        ...
        [DllImport("Resources/encrypt.dll", EntryPoint = "encrypt", CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern void EncryptNative(IntPtr arr, int length, byte[] iv, int ivsize, IntPtr output,
            out int outputSize);
