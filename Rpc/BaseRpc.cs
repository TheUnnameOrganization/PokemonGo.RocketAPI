...
namespace PokemonGo.RocketAPI.Rpc
{
    public class BaseRpc
    {
        ...
        protected RequestBuilder RequestBuilder
            =>
                new RequestBuilder(_client.AuthToken, _client.AuthType, _client.CurrentLatitude,
                    _client.CurrentLongitude, _client.CurrentAltitude, _client.Settings, _client.AuthTicket);
            ...
            where TResponsePayload : IMessage<TResponsePayload>, new()
        {
            ...
            return
                await
                    _client.PokemonHttpClient.PostProtoPayload<TRequest, TResponsePayload>(ApiUrl, requestEnvelops,
                        _client.ApiFailure);
        }
            ...
            where TResponsePayload : IMessage<TResponsePayload>, new()
        {
            return
                await
                    _client.PokemonHttpClient.PostProtoPayload<TRequest, TResponsePayload>(ApiUrl, requestEnvelope,
                        _client.ApiFailure);
        }
            ...
            params Type[] responseTypes) where TRequest : IMessage<TRequest>
        {
            return
                await
                    _client.PokemonHttpClient.PostProtoPayload<TRequest>(ApiUrl, requestEnvelope, _client.ApiFailure,
                        responseTypes);
        }
